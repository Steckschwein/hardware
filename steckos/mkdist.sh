...
TARGET=$1
TOOLS_BIN="clear.prg ls.prg ll.prg stat.prg rename.prg date.prg keycode.prg view.prg rm.prg rmdir.prg mkdir.prg cp.prg pwd.prg touch.prg attrib.prg help.prg"
