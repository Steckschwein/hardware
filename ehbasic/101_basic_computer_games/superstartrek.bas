...
140 REM ***           WESTINGHOUSE DEFENSE & ELECTRONICS SYSTEMS
145 REM ***           CNTR.
...
1252 PRINT" THE GALAXY BEFORE THEY CAN ATTACK FEDERATION"
1253 PRINT" HEADQUARTERS"
1260 PRINT" ON STARDATE";T0+T9;"  THIS GIVES YOU";T9;"DAYS."
1265 PRINT" THERE ";X0$
1272 PRINT" ";B9;"STARBASE";X$;" IN THE GALAXY FOR"
1273 PRINT" RESUPPLYING YOUR SHIP"
1280 PRINT"HIT ANY KEY EXCEPT RETURN WHEN READY TO ACCEPT COMMAND"
...
2020 PRINT:PRINT"** FATAL ERROR **   YOU'VE JUST STRANDED YOUR SHIP"
2021 PRINT" IN "
2030 PRINT"SPACE":PRINT"YOU HAVE INSUFFICIENT MANEUVERING ENERGY,";
2040 PRINT" AND SHIELD CONTROL":PRINT"IS PRESENTLY INCAPABLE OF"
2050 PRINT"CROSS-CIRCUITING TO ENGINE ROOM!!":GOTO6220
...
2475 PRINT" MAXIUM SPEED = WARP 0.2":GOTO1990
...
3500 X=8*Q1+X+N*X1:Y=8*Q2+Y+N*X2:Q1=INT(X/8)
3510 Q2=INT(Y/8):S1=INT(X-Q1*8)
...
4500 PRINT"SENSORS SHOW NO DAMAGE TO ENEMY AT ";
4510 PRINT K(I,1);",";K(I,2):GOTO4670
4530 K(I,3)=K(I,3)-H:PRINTH;
4535 PRINT "UNIT HIT ON KLINGON AT SECTOR";K(I,1);",";
4550 PRINTK(I,2)
4555 IFK(I,3)<=0THEN?"*** KLINGON DESTROYED ***":GOTO4580
...
5260 PRINT"STAR AT";X3;",";Y3;
5265 PRINT"ABSORBED TORPEDO ENERGY.":GOSUB6000:GOTO1990
...
5375 PRINT"  YOU ARE HEREBY RELIEVED OF COMMAND"
5380 PRINT"AND SENTENCED TO 99 STARDATES";
5385 PRINT" AT HARD LABOR ON CYGNUS 12!!"
5390 GOTO 6270
...
5565 INPUT"NUMBER OF UNITS TO SHIELDS";X
...
5665 PRINT "UNITS PER YOUR COMMAND.'":GOTO1990
...
7960 PRINT"MISSION MUST BE COMPLETED IN";
7965 PRINT .1*INT((T0+T9-T)*10);"STARDATES"
7970 X$="S":IFB9<2THENX$="":IFB9<1THEN8010
7980 PRINT"THE FEDERATION IS MAINTAINING";
7985 PRINT B9;"STARBASE";X$;" IN THE GALAXY"
7990 GOTO5690
