...
118 PRINT:PRINT:D1=0:V=0:A=0:N=0:M=0:D1=INT(9001*RND(0)+1000)
...
125 V1=V1*(5280/3600):V=V1+((V1*RND(0))/20)-((V1*RND(1))/20):GOTO 135
128 V1=INT(1000*RND(0))
130 PRINT "OK.  TERMINAL VELOCITY ="V1"MI/HR"
131 V1=V1*(5280/3600):V=V1+((V1*RND(0))/20)-((V1*RND(1))/20) 
...
145 A=A2+((A2*RND(0))/20)-((A2*RND(1))/20):GOTO 205
