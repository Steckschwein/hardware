...
2900 STOP
2910 X=INT(RND(0)*10+1)
2920 Y=INT(RND(0)*10+1)
2930 V=INT(3*RND(0)-1)
2940 V2=INT(3*RND(0)-1)
2950 RETURN
2960 FOR W=1 TO 12
...
3090 X=1+INT(RND(0)*2.5)
3100 GOTO 3120
3110 X=10-INT(RND(0)*2.5)
3120 IF Y>10 THEN 3160
3130 IF Y>0 THEN 3270
3140 Y=1+INT(RND(0)*2.5)
3150 GOTO 3270
3160 Y=10-INT(RND(0)*2.5)
3170 GOTO 3270
3180 F(W)=X
3190 G(W)=Y
