...
TIBX      =TOP		; terminal input buffer of 84 bytes.
ORIG      =$1000         ; origin of FORTH's Dictionary.
MEM       =$c000         ; top of assigned memory+1 byte.
...
OUTCH     = krn_chrout
INCH      = krn_getkey         ; input one ASCII char. to term.
TCR       = lf         ; terminal return and line feed.
;
...
XBLANK    =blank         ; print one blank
CRLF      =lf         ; print a carriage return and line feed.
HEX2      =krn_hexout         ; print accum as two hex numbers
;LETTER    =OUTCH         ; print accum as one ASCII character
ONEKEY    =krn_keyin         ; wait for keystroke
